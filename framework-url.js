function unityFramework(Module) {
  ...
  function _AddDocument(collectionPath, value, objectName, callback, fallback) {
    ...
    try {
      firebase
        ...
        .add(JSON.parse(parsedValue))
        .then(function (unused) {
          window.unityInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: document added in collection " + parsedPath
          );
        })
  ...
  function _AddElementInArrayField(
    collectionPath,
    documentId,
    field,
    value,
    ...
    try {
      var value = {};
      value[parsedField] = firebase.firestore.FieldValue.arrayUnion(
      ...
      firebase
        ...
        .then(function () {
          window.unityInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: element " + parsedValue + " was added in " + parsedField
          );
        })
        .catch(function (error) {
          window.unityInstance.SendMessage(
  ...
  function _CreateUserWithEmailAndPassword(
    ...
    try {
      firebase
        .auth()
        .createUserWithEmailAndPassword(parsedEmail, parsedPassword)
        .then(function (unused) {
          window.unityInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: signed up for " + parsedEmail
          );
        })
        .catch(function (error) {
          window.unityInstance.SendMessage(
      ...
      firebase
        ...
        .then(function () {
          window.unityInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: document " + parsedId + " was deleted"
          );
        })
        .catch(function (error) {
          window.unityInstance.SendMessage(
      ...
      firebase
        ...
        .then(function () {
          window.unityInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: field " + parsedField + " was deleted"
          );
        })
        .catch(function (error) {
          window.unityInstance.SendMessage(
  ...
  function _GetDocumentsInCollection(
    collectionPath,
    objectName,
    callback,
    fallback
      ...
      firebase
        ...
        .then(function () {
          window.unityInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: incremented " + parsedField + " by " + increment
          );
        })
        .catch(function (error) {
          window.unityInstance.SendMessage(
  ...
  function _ListenForCollectionChange(
    collectionPath,
    ...
    try {
      ...
      this.firestorelisteners[parsedPath + "/collection/"] = firebase
        .firestore()
        .collection(parsedPath)
        .onSnapshot(
          {
  ...
  function _ListenForDocumentChange(
    collectionPath,
    documentId,
    includeMetadataChanges,
    objectName,
    ...
    try {
      if (typeof firestorelisteners === "undefined") firestorelisteners = {};
      this.firestorelisteners[parsedPath + "/" + parsedId] = firebase
        .firestore()
        .collection(parsedPath)
        .doc(parsedId)
        .onSnapshot(
  ...
  function _ModifyNumberWithTransaction(
    path,
    amount,
    objectName,
    callback,
  ...
  function _OnAuthStateChanged(objectName, onUserSignedIn, onUserSignedOut) {
    ...
    firebase.auth().onAuthStateChanged(function (user) {
      if (user) {
        window.unityInstance.SendMessage(
          parsedObjectName,
          parsedOnUserSignedIn,
          JSON.stringify(user)
        );
      } else {
        window.unityInstance.SendMessage(
          parsedObjectName,
          parsedOnUserSignedOut,
          "User signed out"
        );
      }
    });
  ...
  function _RemoveElementInArrayField(
    collectionPath,
    documentId,
    field,
    value,
    ...
    try {
      var value = {};
      value[parsedField] = firebase.firestore.FieldValue.arrayRemove(
        JSON.parse(parsedValue)
      );
      firebase
        .firestore()
        ...
        .then(function () {
          window.unityInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: element " + parsedValue + " was removed in " + parsedField
          );
        })
        .catch(function (error) {
          window.unityInstance.SendMessage(
      ...
      firebase
        ...
        .then(function () {
          window.unityInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: document " + parsedId + " was set"
          );
        })
        .catch(function (error) {
          window.unityInstance.SendMessage(
  ...
  function _SignInWithEmailAndPassword(
    ...
    try {
      firebase
        .auth()
        .signInWithEmailAndPassword(parsedEmail, parsedPassword)
        .then(function (unused) {
          window.unityInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: signed in for " + parsedEmail
          );
        })
        .catch(function (error) {
          window.unityInstance.SendMessage(
      ...
      firebase
        ...
        .then(function (unused) {
          window.unityInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: signed in with Facebook!"
          );
        })
        .catch(function (error) {
          window.unityInstance.SendMessage(
  ...
  function _StopListeningForCollectionChange(
    collectionPath,
    objectName,
    callback,
    fallback
  ...
  function _StopListeningForDocumentChange(
    collectionPath,
    documentId,
    objectName,
    callback,
      ...
      firebase
        ...
        .then(function () {
          window.unityInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: document " + parsedId + " was updated"
          );
        })
        .catch(function (error) {
          window.unityInstance.SendMessage(
      ...
      firebase
        ...
        .then(function (snapshot) {
          window.unityInstance.SendMessage(
            parsedObjectName,
            parsedCallback,
            "Success: data was posted to " + parsedPath
          );
        });
    } catch (error) {
      window.unityInstance.SendMessage(
  ...
  var asmLibraryArg = {
    $h: _AddDocument,
    Xh: _AddElementInArrayField,
    wi: _CreateUserWithEmailAndPassword,
    Zh: _DeleteDocument,
    Yh: _DeleteField,
    ni: _DeleteJSON,
    Oh: _DownloadFile,
    Eh: _GD_SDK_Init,
    Dh: _GD_SDK_PreloadAd,
    Bh: _GD_SDK_SendEvent,
    Ch: _GD_SDK_ShowAd,
    Qh: _GetCurrentProjectId,
    ci: _GetDocument,
    bi: _GetDocumentsInCollection,
    ri: _GetJSON,
    Vh: _IncrementFieldValue,
    te: _JS_Accelerometer_IsRunning,
    $a: _JS_Accelerometer_Start,
    se: _JS_Accelerometer_Stop,
    ...
    bf: _JS_Sound_SetLoop,
    rb: _JS_Sound_SetLoopPoints,
    ua: _JS_Sound_SetPaused,
    af: _JS_Sound_SetPitch,
    ef: _JS_Sound_SetPosition,
    df: _JS_Sound_SetVolume,
    xa: _JS_Sound_Stop,
    ie: _JS_SystemInfo_GetCanvasClientSize,
    ...
    Vd: _JS_SystemInfo_GetOS,
    Va: _JS_SystemInfo_GetPreferredDevicePixelRatio,
    Yd: _JS_SystemInfo_GetScreenSize,
    th: _JS_SystemInfo_GetStreamingAssetsURL,
    ...
    Pe: _JS_WebRequest_Create,
    Qe: _JS_WebRequest_GetResponseMetaData,
    Re: _JS_WebRequest_GetResponseMetaDataLengths,
    Se: _JS_WebRequest_Release,
    Le: _JS_WebRequest_Send,
    Ne: _JS_WebRequest_SetRedirectLimit,
    Me: _JS_WebRequest_SetRequestHeader,
    Oe: _JS_WebRequest_SetTimeout,
    ki: _ListenForChildAdded,
    ii: _ListenForChildChanged,
    gi: _ListenForChildRemoved,
    Sh: _ListenForCollectionChange,
    Uh: _ListenForDocumentChange,
    mi: _ListenForValueChanged,
    Mh: _LogEvent,
    Lh: _LogEventParameter,
    ei: _ModifyNumberWithTransaction,
    si: _OnAuthStateChanged,
    qi: _PostJSON,
    pi: _PushJSON,
    uh: _Redirect,
    vh: _RedirectDomain,
    Wh: _RemoveElementInArrayField,
    wh: _SDK_FocusGameContainer,
    Ah: _SDK_Init,
    bc: _SDK_InitParam,
    zh: _SDK_PreloadAd,
    xh: _SDK_SendEvent,
    yh: _SDK_ShowAd,
    ai: _SetDocument,
    Nh: _SetUserProperties,
    xi: _SignInAnonymously,
    vi: _SignInWithEmailAndPassword,
    ti: _SignInWithFacebook,
    ui: _SignInWithGoogle,
    ji: _StopListeningForChildAdded,
    hi: _StopListeningForChildChanged,
    fi: _StopListeningForChildRemoved,
    Rh: _StopListeningForCollectionChange,
    Th: _StopListeningForDocumentChange,
    li: _StopListeningForValueChanged,
    di: _ToggleBooleanWithTransaction,
    _h: _UpdateDocument,
    oi: _UpdateJSON,
    Ph: _UploadFile,
    ...
    J: ___sys_fcntl64,
    yf: ___sys_fstat64,
    mf: ___sys_ftruncate64,
    tc: ___sys_getcwd,
    qc: ___sys_getdents64,
    dc: ___sys_getegid32,
    ec: ___sys_geteuid32,
    Fc: ___sys_getpeername,
    ma: ___sys_getpid,
    pc: ___sys_getrusage,
    he: ___sys_getsockname,
    ye: ___sys_getsockopt,
    kf: ___sys_getuid32,
    Sa: ___sys_ioctl,
    $d: ___sys_listen,
    xc: ___sys_lstat64,
    ...
    Cc: ___sys_sendmsg,
    zd: ___sys_sendto,
    dd: ___sys_setsockopt,
    Ec: ___sys_shutdown,
    Qa: ___sys_socket,
    xb: ___sys_stat64,
    gf: ___sys_statfs64,
    hf: ___sys_truncate64,
    Gc: ___sys_uname,
    vc: ___sys_unlink,
    A: _abort,
    I: _clock,
    ...
    Hg: _glDrawArrays,
    Ff: _glDrawArraysInstanced,
    Cf: _glDrawBuffers,
    Ig: _glDrawElements,
    Ef: _glDrawElementsInstanced,
    Jg: _glEnable,
  ...
  var _ReleaseKeys = (Module["_ReleaseKeys"] = function () {
    return (_ReleaseKeys = Module["_ReleaseKeys"] = Module["asm"]["Ji"]).apply(
      null,
      arguments
    );
  });
  ...
  var _SendMessage = (Module["_SendMessage"] = function () {
    return (_SendMessage = Module["_SendMessage"] = Module["asm"]["Mi"]).apply(
      null,
      arguments
    );
  });
  ...
  var _main = (Module["_main"] = function () {
    return (_main = Module["_main"] = Module["asm"]["Oi"]).apply(
      null,
      arguments
    );
  });
  ...
  var _htonl = (Module["_htonl"] = function () {
    return (_htonl = Module["_htonl"] = Module["asm"]["Qi"]).apply(
      null,
      arguments
    );
  });
  ...
  var _ntohs = (Module["_ntohs"] = function () {
    return (_ntohs = Module["_ntohs"] = Module["asm"]["Si"]).apply(
      null,
      arguments
    );
  });
  var __get_tzname = (Module["__get_tzname"] = function () {
    return (__get_tzname = Module["__get_tzname"] = Module["asm"]["Ti"]).apply(
      null,
      arguments
    );
  });
  ...
  var stackSave = (Module["stackSave"] = function () {
    return (stackSave = Module["stackSave"] = Module["asm"]["Wi"]).apply(
      null,
      arguments
    );
  });
  var stackRestore = (Module["stackRestore"] = function () {
    return (stackRestore = Module["stackRestore"] = Module["asm"]["Xi"]).apply(
      null,
      arguments
    );
  });
  var stackAlloc = (Module["stackAlloc"] = function () {
    return (stackAlloc = Module["stackAlloc"] = Module["asm"]["Yi"]).apply(
      null,
      arguments
    );
  });
  var _setThrew = (Module["_setThrew"] = function () {
    return (_setThrew = Module["_setThrew"] = Module["asm"]["Zi"]).apply(
      null,
      arguments
    );
  });
  ...
  var _memalign = (Module["_memalign"] = function () {
    return (_memalign = Module["_memalign"] = Module["asm"]["cj"]).apply(
      null,
      arguments
    );
  });
  var _memset = (Module["_memset"] = function () {
    return (_memset = Module["_memset"] = Module["asm"]["dj"]).apply(
      null,
      arguments
    );
  });
  var _strlen = (Module["_strlen"] = function () {
    return (_strlen = Module["_strlen"] = Module["asm"]["ej"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vii = (Module["dynCall_vii"] = function () {
    return (dynCall_vii = Module["dynCall_vii"] = Module["asm"]["hj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_v = (Module["dynCall_v"] = function () {
    return (dynCall_v = Module["dynCall_v"] = Module["asm"]["mj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_iii = (Module["dynCall_iii"] = function () {
    return (dynCall_iii = Module["dynCall_iii"] = Module["asm"]["nj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_viii = (Module["dynCall_viii"] = function () {
    return (dynCall_viii = Module["dynCall_viii"] = Module["asm"]["oj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iiij = (Module["dynCall_iiij"] = function () {
    return (dynCall_iiij = Module["dynCall_iiij"] = Module["asm"]["uj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iij = (Module["dynCall_iij"] = function () {
    return (dynCall_iij = Module["dynCall_iij"] = Module["asm"]["yj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jii = (Module["dynCall_jii"] = function () {
    return (dynCall_jii = Module["dynCall_jii"] = Module["asm"]["Aj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fii = (Module["dynCall_fii"] = function () {
    return (dynCall_fii = Module["dynCall_fii"] = Module["asm"]["Ej"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ijji = (Module["dynCall_ijji"] = function () {
    return (dynCall_ijji = Module["dynCall_ijji"] = Module["asm"]["Sj"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iiji = (Module["dynCall_iiji"] = function () {
    return (dynCall_iiji = Module["dynCall_iiji"] = Module["asm"]["Zj"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fiii = (Module["dynCall_fiii"] = function () {
    return (dynCall_fiii = Module["dynCall_fiii"] = Module["asm"]["_j"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_dji = (Module["dynCall_dji"] = function () {
    return (dynCall_dji = Module["dynCall_dji"] = Module["asm"]["sk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_diii = (Module["dynCall_diii"] = function () {
    return (dynCall_diii = Module["dynCall_diii"] = Module["asm"]["wk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vidi = (Module["dynCall_vidi"] = function () {
    return (dynCall_vidi = Module["dynCall_vidi"] = Module["asm"]["Qk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iji = (Module["dynCall_iji"] = function () {
    return (dynCall_iji = Module["dynCall_iji"] = Module["asm"]["Xk"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iifi = (Module["dynCall_iifi"] = function () {
    return (dynCall_iifi = Module["dynCall_iifi"] = Module["asm"]["el"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ifi = (Module["dynCall_ifi"] = function () {
    return (dynCall_ifi = Module["dynCall_ifi"] = Module["asm"]["kl"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fifi = (Module["dynCall_fifi"] = function () {
    return (dynCall_fifi = Module["dynCall_fifi"] = Module["asm"]["Hl"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ffi = (Module["dynCall_ffi"] = function () {
    return (dynCall_ffi = Module["dynCall_ffi"] = Module["asm"]["Tl"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fffi = (Module["dynCall_fffi"] = function () {
    return (dynCall_fffi = Module["dynCall_fffi"] = Module["asm"]["fm"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vffi = (Module["dynCall_vffi"] = function () {
    return (dynCall_vffi = Module["dynCall_vffi"] = Module["asm"]["qm"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ifii = (Module["dynCall_ifii"] = function () {
    return (dynCall_ifii = Module["dynCall_ifii"] = Module["asm"]["xm"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ijii = (Module["dynCall_ijii"] = function () {
    return (dynCall_ijii = Module["dynCall_ijii"] = Module["asm"]["Zm"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_idii = (Module["dynCall_idii"] = function () {
    return (dynCall_idii = Module["dynCall_idii"] = Module["asm"]["bn"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jjii = (Module["dynCall_jjii"] = function () {
    return (dynCall_jjii = Module["dynCall_jjii"] = Module["asm"]["dn"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iddi = (Module["dynCall_iddi"] = function () {
    return (dynCall_iddi = Module["dynCall_iddi"] = Module["asm"]["jn"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_ffii = (Module["dynCall_ffii"] = function () {
    return (dynCall_ffii = Module["dynCall_ffii"] = Module["asm"]["zn"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_dddi = (Module["dynCall_dddi"] = function () {
    return (dynCall_dddi = Module["dynCall_dddi"] = Module["asm"]["Cn"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_iidi = (Module["dynCall_iidi"] = function () {
    return (dynCall_iidi = Module["dynCall_iidi"] = Module["asm"]["Kn"]).apply(
      null,
      arguments
    );
  });
  var dynCall_jidi = (Module["dynCall_jidi"] = function () {
    return (dynCall_jidi = Module["dynCall_jidi"] = Module["asm"]["Ln"]).apply(
      null,
      arguments
    );
  });
  var dynCall_diji = (Module["dynCall_diji"] = function () {
    return (dynCall_diji = Module["dynCall_diji"] = Module["asm"]["Mn"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fidi = (Module["dynCall_fidi"] = function () {
    return (dynCall_fidi = Module["dynCall_fidi"] = Module["asm"]["Nn"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vfi = (Module["dynCall_vfi"] = function () {
    return (dynCall_vfi = Module["dynCall_vfi"] = Module["asm"]["On"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vjii = (Module["dynCall_vjii"] = function () {
    return (dynCall_vjii = Module["dynCall_vjii"] = Module["asm"]["uo"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_didi = (Module["dynCall_didi"] = function () {
    return (dynCall_didi = Module["dynCall_didi"] = Module["asm"]["gp"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_jfi = (Module["dynCall_jfi"] = function () {
    return (dynCall_jfi = Module["dynCall_jfi"] = Module["asm"]["Bp"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fji = (Module["dynCall_fji"] = function () {
    return (dynCall_fji = Module["dynCall_fji"] = Module["asm"]["Cp"]).apply(
      null,
      arguments
    );
  });
  var dynCall_fdi = (Module["dynCall_fdi"] = function () {
    return (dynCall_fdi = Module["dynCall_fdi"] = Module["asm"]["Dp"]).apply(
      null,
      arguments
    );
  });
  var dynCall_dfi = (Module["dynCall_dfi"] = function () {
    return (dynCall_dfi = Module["dynCall_dfi"] = Module["asm"]["Ep"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vif = (Module["dynCall_vif"] = function () {
    return (dynCall_vif = Module["dynCall_vif"] = Module["asm"]["oq"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_viff = (Module["dynCall_viff"] = function () {
    return (dynCall_viff = Module["dynCall_viff"] = Module["asm"]["wq"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vij = (Module["dynCall_vij"] = function () {
    return (dynCall_vij = Module["dynCall_vij"] = Module["asm"]["xq"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ijj = (Module["dynCall_ijj"] = function () {
    return (dynCall_ijj = Module["dynCall_ijj"] = Module["asm"]["yq"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vjji = (Module["dynCall_vjji"] = function () {
    return (dynCall_vjji = Module["dynCall_vjji"] = Module["asm"]["zq"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ij = (Module["dynCall_ij"] = function () {
    return (dynCall_ij = Module["dynCall_ij"] = Module["asm"]["Aq"]).apply(
      null,
      arguments
    );
  });
  var dynCall_vid = (Module["dynCall_vid"] = function () {
    return (dynCall_vid = Module["dynCall_vid"] = Module["asm"]["Bq"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_fff = (Module["dynCall_fff"] = function () {
    return (dynCall_fff = Module["dynCall_fff"] = Module["asm"]["lr"]).apply(
      null,
      arguments
    );
  });
  ...
  var dynCall_vfff = (Module["dynCall_vfff"] = function () {
    return (dynCall_vfff = Module["dynCall_vfff"] = Module["asm"]["nr"]).apply(
      null,
      arguments
    );
  });
  var dynCall_ff = (Module["dynCall_ff"] = function () {
    return (dynCall_ff = Module["dynCall_ff"] = Module["asm"]["or"]).apply(
      null,
      arguments
    );
  });
